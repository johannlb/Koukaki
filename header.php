                    ...
                    <nav id="site-navigation" class="main-navigation menu-burger">
                        ...
                        <div class="menu-on">
                            <div class="images-menu">
                                ...
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/hibiscus_footer.png'; ?> " alt="Fleur hibiscus" class="hibiscus">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/random_flower.png'; ?> " alt="Fleur random" class="flower-random">
